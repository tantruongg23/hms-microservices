...
public final class HelloServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "vn.tayjava.grpc.HelloService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<vn.tayjava.grpc.HelloRequest,
      vn.tayjava.grpc.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = vn.tayjava.grpc.HelloRequest.class,
      responseType = vn.tayjava.grpc.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<vn.tayjava.grpc.HelloRequest,
      vn.tayjava.grpc.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<vn.tayjava.grpc.HelloRequest, vn.tayjava.grpc.HelloResponse> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<vn.tayjava.grpc.HelloRequest, vn.tayjava.grpc.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  vn.tayjava.grpc.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  vn.tayjava.grpc.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void hello(vn.tayjava.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<vn.tayjava.grpc.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceStub
    ...
    /**
     */
    public void hello(vn.tayjava.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<vn.tayjava.grpc.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceBlockingStub
    ...
    /**
     */
    public vn.tayjava.grpc.HelloResponse hello(vn.tayjava.grpc.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<vn.tayjava.grpc.HelloResponse> hello(
        vn.tayjava.grpc.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((vn.tayjava.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<vn.tayjava.grpc.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              vn.tayjava.grpc.HelloRequest,
              vn.tayjava.grpc.HelloResponse>(
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return vn.tayjava.grpc.HelloServiceOuterClass.getDescriptor();
    }
